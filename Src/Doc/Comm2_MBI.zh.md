...
<td>1</td>
<td>固定为<br />
N(<span style="color: red">Comm2Demo</span>)<br />
1(Comm2/<span style="color: red">2P</span>)<br />
2(<span style="color: red">Comm3</span>)</td>
<td>31/32</td>
</tr>
<tr class="even">
<td>Identifying Sign</td>
<td>String</td>
<td>3</td>
<td>固定</td>
<td>49424D(IBM)</td>
...
<td>n<br />
(<span style="color: red">Comm2Demo</span>)</td>
<td>Int32</td>
<td>4</td>
<td>边数(注5)</td>
<td>04000000</td>
...
<tr class="odd">
<td>n<br />
(<span style="color: red">Comm3</span>/<span style="color: red">2P</span>)</td>
<td>Halfbyte<br />
(低4位)</td>
<td>4bits</td>
<td>边数(注5)</td>
...
<tr class="even">
<td>Attribute<br />
(<span style="color: red">Comm3</span>)</td>
<td>Halfbyte<br />
(高4位)</td>
<td>4bits</td>
...
<tr class="odd">
<td>Ext Texture ID<br />
(<span style="color: red">Comm2P</span>)</td>
<td>Halfbyte<br />
(高4位)</td>
<td>4bits</td>
<td>扩展贴图编号(8-11位)</td>
...
<tr class="odd">
<td>Texture ID<br />
(Comm2/<span style="color: red">3</span>/<span style="color: red">2P</span>)</td>
<td>Byte</td>
<td>1</td>
<td>当前区域使用的贴图的编号</td>
<td>00</td>
...
<tr class="odd">
<td>Point 0<br />
(Comm2/<span style="color: red">3</span>)</td>
<td>Int16</td>
<td>2</td>
...
<td rowspan="5">Object Info DB<br />
(Comm2/<span style="color: red">3</span>/<span style="color: red">2P</span>)</td>
<td></td>
<td>Num Object</td>
<td>Int32</td>
