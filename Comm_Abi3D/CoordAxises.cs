...
namespace Comm_Abi3D
{
	...
	public class CoordAxies
	{
		...
		public void CreateAllBuffer(Device device, Vector3 center, float radius)
		{
			if (first)
			{
				...
				arrows[0].CreateAllBuffer(device, AxisArrow.Point_To_X_Axis(center, radius));
			...
			else
			{
				...
				arrows[1].CreateAllBuffer(device, AxisArrow.Point_To_Y_Axis(this.center, this.radius));
				arrows[2].CreateAllBuffer(device, AxisArrow.Point_To_Z_Axis(this.center, this.radius));
			}
		}
	...
	class AxisArrow
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////
		static public Matrix Point_To_X_Axis(Vector3 center, float radius)
		{
		...
		static public Matrix Point_To_Y_Axis(Vector3 center, float radius)
		{
			Matrix m = Matrix.Scaling(radius / 30f, radius / 30f, radius / 30f);
		...
		static public Matrix Point_To_Z_Axis(Vector3 center, float radius)
		{
			Matrix m = Matrix.Scaling(radius / 30f, radius / 30f, radius / 30f);
			m *= Matrix.Translation(center);
			m.M43 += 2 * radius;
